...
public class HomeTopVideoAdapter extends BaseQuickAdapter<VideoInfoDao, BaseViewHolder> {
    public HomeTopVideoAdapter(int layoutResId, @Nullable List<VideoInfoDao> data) {
