...
public class HostipalMienVideoAdapter extends BaseQuickAdapter<VideoInfoDao, BaseViewHolder> {

    public HostipalMienVideoAdapter(int layoutResId, @Nullable List<VideoInfoDao> data) {
