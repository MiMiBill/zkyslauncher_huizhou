...
public class BluetoothLeService {
    ...
    public boolean isBLELockConnected;
    private static BluetoothLeService service = new BluetoothLeService();
...
//    }
    ...
    public boolean initBluetooth() {
        mBluetoothManager = (BluetoothManager) LauncherApplication.getContext().getSystemService(Context.BLUETOOTH_SERVICE);
...
//        }
    ...
    public boolean connect(final String address) {
        ...
        mBluetoothGatt = device.connectGatt(LauncherApplication.getContext(), false, mGattCallback);
...
//    }
    ...
    public boolean writeCharacteristic(byte[] bytes) {
        ...
        if (miWen != null) {
            ...
            boolean is = mBluetoothGatt.writeCharacteristic(write_characteristic);
            LogUtil.d("写入是否成功：" + is);
            return is;
        }
        return false;
