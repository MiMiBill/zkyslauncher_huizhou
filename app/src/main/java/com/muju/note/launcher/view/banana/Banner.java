...
//                    LogFactory.l().i("pageIndex--" + pageIndex + "--autoCurrIndex--" + autoCurrIndex);
                }
...
//                    LogFactory.l().e("index==="+index);
                    if(index==-100){
                        if(bannerPage.url.equals("00")){
                            Glide.with(getContext()).load(R.mipmap.ic_protection_bg).apply(options).into(imageView);
                        }else if(bannerPage.url.equals("11")){
                            Glide.with(getContext()).load(R.mipmap.iv_lock).apply(options).into(imageView);
                        }else if(bannerPage.url.equals("22")){
                            Glide.with(getContext()).load(R.mipmap.home_default_1).apply(options).into(imageView);
                        }else if(bannerPage.url.equals("33")){
                            Glide.with(getContext()).load(R.mipmap.home_default_2).apply(options).into(imageView);
                        }
                    }else {
