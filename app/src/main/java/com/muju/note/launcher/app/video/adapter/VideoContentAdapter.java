...
public class VideoContentAdapter extends BaseQuickAdapter<VideoInfoDao,BaseViewHolder> {

    public VideoContentAdapter(int layoutResId, @Nullable List<VideoInfoDao> data) {
